...
importInput.addEventListener("change", (e) => {
  ...
  reader.onload = (ev) => {
    try {
      ...
      // Мягкая валидация и слияние с существующими
      const valid = data
      ...
      alert("Не удалось прочитать файл. Убедись, что это JSON с задачами.");
    } finally {
      importInput.value = "";
    }
  };
...
// Автообновление статуса «просрочено» раз в минуту
